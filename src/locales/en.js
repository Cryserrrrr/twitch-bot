...
module.exports = {
  ...
  discord: {
    defaultMessage: "{streamer} is live: **{title}** {url}",
    testPrefix: "🧪 Test message, nobody was mentioned.",
    liveNow: "Live on Twitch",
    game: "Game",
    ended: "Stream ended",
    endedDescription: "The stream is over, it lasted {duration}.",
  },
